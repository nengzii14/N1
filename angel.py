...
cl = LINETCR.LINE()
cl.login(token="Eq7feuX4ghQA7fBrM9le.ebQ+duF2aNQHxhCV7FeT3G.Aun78fWT1VIVNvBPB94GStyPVWhdzm66afG3NMeXrMQ=")
cl.loginResult()
...
╠═════════════════════════
║             
║    By : ป๋าโหน่ง line.me/ti/p/~nong1426
╚═════════════════════════
"""
...
╚═════════════════════════
"""
tjia="u3b4d3e582a005f8efa2ad5b847aa204c"
...
Bots=[mid]
Creator=["u446015c6dce1ba353408e4f01477abc0","u3b4d3e582a005f8efa2ad5b847aa204c"]
admin=["u446015c6dce1ba353408e4f01477abc0","u3b4d3e582a005f8efa2ad5b847aa204c"]
	 ...
	 if wait["Ghost"] == True:
        ...
        if op.type == 26:
			...
			cl.sendText(msg.to,"Admin Detected~")
                ...
                cl.sendMessage(msg)
		cl.sendText(msg.to,"คอนแทคแอดมินบอท")
		
            elif msg.text in ["Admin","admin"]:
                msg.contentType = 13
                admin1 = "u3b4d3e582a005f8efa2ad5b847aa204c"
                admin2 = "ue235033ef54e2d40020dc347239928a8"
                admin3 = "uf1d94ae5a92ce6c73743893a5623ee72"
                msg.contentMetadata = {'mid': tjia}
		...
		gid = cl.getGroupIdsJoined()
            ...
            elif msg.text in ["Botnongcancel1"]:
                if msg.toType == 2:
...
#		    cl.sendText(msg.to,"Khusus Nadya")
                ...
                if wait["Welcomen"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"ยินดีต้อนรับเปิดการใช้งานヾ(*´∀｀*)ﾉ")
                else:
                    wait["Welcome"] = True
                    wait["joinkick"] = False
                    if wait["lang"] == "JP":
                ...
                if wait["Welcome"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"ยินดีต้อนรับปิดการใช้งาน(　＾∇＾)")
                else:
                    wait["Welcome"] = False
                    if wait["lang"] == "JP":
		...
		if wait["Simi"] == True: md+="╠➩✔️ Simisimi : On\n"
            ...
            elif msg.text in ["Botnong","botnong"]:
		...
		if msg.from_ in Creator:
		    cl.sendText(msg.to, "Bot ถูกรีสตาร์ทแล้ว...")
		    restart_program()
		    print "@Restart"
		else:
